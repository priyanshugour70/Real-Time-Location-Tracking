...
<body>
    ...
    <main>
        ...
        <div class="container ">
            <h1 class="fw-bolder" style="text-align: center; margin:5vh;"> SAGE Management & Law</h1>
        </div>
        ...
        button.addEventListener("click", () => {
            navigator.geolocation.getCurrentPosition((position) => {
                ...
                const boroughs = [{
                    ...
                    {
                        name: 'SAGE Management & Law',
                        color: '#00ffff',
                        lngLat: [77.52314020, 23.18532160]
                    }
