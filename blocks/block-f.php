...
<body>
    ...
    <div class="container ">
		<h1 class="fw-bolder" style="text-align: center; margin:5vh;" >SAGE University Block-F</h1>
	</div>
		...
		<div class="px-4 pt-5 my-5 text-center border-bottom">
			...
			<div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
				<button href="#" class="btn btn-outline-dark btn-lg px-4" target="_blank" id="get-location">Get Location</button>
		...
		button.addEventListener("click", () => {
			navigator.geolocation.getCurrentPosition((position) => {
				...
				const boroughs = [{
					...
					{
						name: 'SAGE University Block-F',
						color: '#00ffff',
						lngLat: [77.52320490, 23.18411960]
					}
