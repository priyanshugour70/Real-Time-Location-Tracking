...
<body>
    ...
    <div class="container ">
		<h1 class="fw-bolder" style="text-align: center; margin:5vh;" > SAGE University Block - A</h1>
	</div>
		...
		button.addEventListener("click", () => {
			navigator.geolocation.getCurrentPosition((position) => {
				...
				const boroughs = [{
					...
					{
						name: 'Sage University Block-A',
						color: '#00ffff',
						lngLat: [77.52280511836871, 23.184241750367462]
					}
