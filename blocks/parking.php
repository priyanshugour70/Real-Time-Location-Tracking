...
<body>
    ...
    <div class="container ">
		<h1 class="fw-bolder" style="text-align: center; margin:5vh;" > SAGE University Parking</h1>
	</div>
		...
		button.addEventListener("click", () => {
			navigator.geolocation.getCurrentPosition((position) => {
				...
				const boroughs = [{
					...
					{
						name: 'Sage University Parking',
						color: '#00ffff',
						lngLat: [77.52167090, 23.18418040]
					}
