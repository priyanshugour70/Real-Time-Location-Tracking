...
<head>
	...
	<title>RTLT | Royal Sage Hall</title>
...
<body>
    ...
    <div class="container ">
		<h1 class="fw-bolder" style="text-align: center; margin:5vh;" > Royal SAGE Hall</h1>
	</div>
		...
		button.addEventListener("click", () => {
			navigator.geolocation.getCurrentPosition((position) => {
				...
				const boroughs = [{
					...
					{
						name: 'Royal SAGE Hall',
						color: '#00ffff',
						lngLat: [77.52237200, 23.18505010]
					}
