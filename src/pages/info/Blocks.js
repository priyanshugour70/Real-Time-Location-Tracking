            ...
            <div className="container my-24 px-6 mx-auto">
                ...
                <section className="mb-28 text-gray-800 text-center md:text-left">
                    ...
                    <div className="grid md:grid-cols-2 gap-x-6 xl:gap-x-12 items-center mb-12">
                        ...
                        <div className="mb-6 md:mb-0">
                            ...
                            <p className="text-gray-500">
                                visit the administrative block for various
                                reasons such as seeking information, submitting
                                documents, paying fees, resolving issues, and
                                accessing administrative services and support.
                            </p>
                        </div>
                    </div>
                    <div className="grid md:grid-cols-2 gap-x-6 xl:gap-x-12 items-center mb-12">
                        ...
                        <div className="mb-6 md:mb-0 md:order-1">
                            <h3 className="text-2xl font-bold mb-3">F-Block</h3>
                            ...
                            <p className="text-gray-500">
                                visit the technical block for various reasons,
                                such as attending specialized technical classes,
                                accessing laboratories and workshops, seeking
                                guidance from faculty members, and engaging in
                    ...
                    <div className="grid md:grid-cols-2 gap-x-6 xl:gap-x-12 items-center mb-12">
                        ...
                        <div className="mb-6 md:mb-0">
                            <h3 className="text-2xl font-bold mb-3">A-Block</h3>
                            ...
                            <p className="text-gray-500">
                                medical block for various reasons, such as
                                seeking medical assistance, visiting the campus
                                clinic, getting vaccinations, or attending
                                health-related workshops or events.
                            </p>
                        </div>
                    </div>
                </section>
